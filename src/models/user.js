...
const UserModel = {
  ...
  effects: {
    *fetchCurrent(_, { call, put }) {
      ...
      yield put({ type: 'saveCurrentUser', payload: {currentUser: { ...response }} });
    },
    ...
    *getUserDetail(_, { call, put }) {
      ...
      yield put({ type: 'saveCurrentUser', payload: { userDetail: { ...response }} });
    },
    // 退出
    *loginOut(_, { call, put }) {
      const response = yield call(loginOut);
      yield put({ type: 'loginOut', payload: { currentUser: {}, userDetail: { } } });
    },
  },
  reducers: {
